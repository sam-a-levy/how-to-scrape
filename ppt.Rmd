...
2. Where data has clear structure reflected in nodes with unique identifiers (via tag/class/XPATH), scraping can be completed with a very small amount of code
3. Where data has a messy structure, you should:
    - Use recursive procedures to work node by node (e.g. `purrr::map` in R) 
    - Use nested data structures that maintain html trees (e.g. `lists` in R)
...
<font size="5">note: code used to create this presentation can be found on my [GitHub](https://github.com/sam-a-levy/how-to-scrape)</font>
